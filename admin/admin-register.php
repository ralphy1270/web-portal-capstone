...
require 'includes/form_handlers/admin_register_handler.php';
...
<html>
<head>
	<title>Youth and Sports Develpment of Sta. Cruz, Laguna</title>
	<meta charset="utf-8">
		...
		<div class="row-card row">
			...
			<div id="second">
				...
				<form action="admin-register.php" method="POST">
					...
					<?php if(in_array("<span style='color: #14C800;'>Success! Wait for Super Admin to confirm account</span><br>", $error_array)) echo "<span style='color: #14C800;'>Success! Wait for Super Admin to confirm account</span><br>"; ?>
