...
/*error_reporting(0); */
$profile_id = $_SESSION['username_applicant'];
$imgSrc = "";
$result_path = "";
$msg = "";
...
***********************************************************/
	if (!isset($_POST['x']) && !isset($_FILES['image']['name']) ){
		//Delete users temp image
			$temppath = 'admin/assets/images/profile_pics/'.$profile_id.'_temp.jpeg';
...
***********************************************************/	
	...
	//Set Upload directory    
		$uploaddir = $_SERVER['DOCUMENT_ROOT'].'/PORTAL/admin/assets/images/profile_pics';
	//Set File name	
	...
	//Move the file to correct location
		...
		if (!$move) { 
			...
			$imgSrc= "admin/assets/images/profile_pics/".$file_name; // the image to display in crop area
...
if (isset($_POST['x'])){
	...
	//the file type posted
		$type = $_POST['type'];	
	//the image src
		$src = 'admin/assets/images/profile_pics/'.$_POST['src'];	
	...
	if($type == 'jpg' || $type == 'jpeg' || $type == 'JPG' || $type == 'JPEG'){	
		...
		//save the new cropped version
			imagejpeg($dst_r, "admin/assets/images/profile_pics/".$finalname."n.jpeg", 90); 	
		...
		$result_path ="admin/assets/images/profile_pics/".$finalname."n.jpeg";
...
<div class="main_column column">
    ...
    if($imgSrc){ //if an image has been uploaded display cropping area?>
	    ...
	    <div id="CroppingContainer" style="width:800px; max-height:600px; background-color:#FFF; margin-left: 1px; position:relative; overflow:hidden; border:2px #666 solid; z-index:2001; padding-bottom:0px;">  
	        ...
	        <div id="CropImageForm" style="width:100px; height:30px; float:left; margin:0px 0px 0px 40px;" >  
