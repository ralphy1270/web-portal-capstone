...
<div class="main_column column">
	...
	<?php
	echo "<img src='" . $profile_pic ."' class='small_profile_pic'>";
	?>
	<br>
	...
	<?php
	$user_data_query = mysqli_query($con, "SELECT first_name, last_name, email FROM users WHERE username='$loggedin_user'");
