		...
		<div class="col-12 col-md-9 content-info">
			...
			<div class="updates-body">
				...
				<div class="col-md-12 label-latest-events-div">
					<div class='label-latest-events'> <?php echo $post_type; ?> </div>
				</div>
...
<script>
	...
	$(document).ready(function() {
		...
		$.ajax({
			url: "includes/handlers/ajax_load_categories.php",
			type: "POST",
			data: "page=1&category=" + category + "&post_type=" + post_type,
			cache:false,
			...
			//if (noMorePosts == 'false') {
				if (noMorePosts == 'false') {	
					...
					var ajaxReq = $.ajax({
						url: "includes/handlers/ajax_load_categories.php",
						type: "POST",
						data: "page=" + page + "&category=" + category + "&post_type=" + post_type,
						cache:false,
